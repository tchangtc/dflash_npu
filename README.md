# DFlash NPU: Block Diffusion for Flash Speculative Decoding on Ascend NPU

[**Original Paper**](https://arxiv.org/abs/2602.06036) | [**Original Project**](https://github.com/z-lab/dflash) | [**Models**](https://huggingface.co/collections/z-lab/dflash)

> **Note**: This repository is an NPU adaptation of the original [DFlash](https://github.com/z-lab/dflash) project by [z-lab](https://github.com/z-lab). We gratefully acknowledge the original authors for their groundbreaking work on block diffusion for speculative decoding.
